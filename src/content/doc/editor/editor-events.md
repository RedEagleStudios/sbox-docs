...
Editor Events are events that are broadcast globally throughout the editor and can be listened to/fired from any [Editor Project](/doc/editor/editor-project). These are useful for creating your own custom Editor Tools and making sure they can work in tandem with existing systems.
