...
You can create your own editor tool to help you create your game. Your tool needs to be created in an [editor project](/doc/editor/editor-project).
...
![](https://cdn.sbox.game/doc/d4a85745-5a7d-491b-bf2c-31d16e37349c)
...
Depending on how your tool operates, you might want to prevent the user's ability to click to select [GameObjects](/doc/scene/gameobject) in the scene. To do this you can change `AllowGameObjectSelection` on your tool.
...
![](https://cdn.sbox.game/doc/1c34c993-ffc0-424b-9290-c951c28db69a)