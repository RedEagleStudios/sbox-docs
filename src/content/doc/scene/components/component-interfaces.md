...
- [OnAwake](/doc/scene/components/component-methods/#h-onawake)

- [OnEnabled](/doc/scene/components/component-methods/#h-onenabled)

- [OnDisabled](/doc/scene/components/component-methods/#h-ondisabled)

- [OnUpdate](/doc/scene/components/component-methods/#h-onupdate)

- [OnFixedUpdate](/doc/scene/components/component-methods/#h-onfixedupdate)
...
A component with this interface can react to [📆 Network Events](/doc/systems/networking-multiplayer/network-events/#h-inetworklistener).

# INetworkSpawn

A component with this interface can react to [📆 Network Events](/doc/systems/networking-multiplayer/network-events/#h-inetworkspawn)