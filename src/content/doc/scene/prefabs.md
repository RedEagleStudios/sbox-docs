...
Prefabs are saved to disk as [PrefabFile]. These assets can be referenced in Components anywhere a [GameObject](/doc/scene/gameobject) can be referenced. When the PrefabFile is updated, all instantiations of the prefab in scenes are updated, too.
