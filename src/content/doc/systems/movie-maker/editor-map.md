...
Switch to the keyframe editor mode, for simpler animations. Find out more [here](/doc/systems/movie-maker/keyframe-editing).

### Motion Editor

Switch to the motion editor mode, for finer control than keyframe editing. Find out more [here](/doc/systems/movie-maker/motion-editing).
