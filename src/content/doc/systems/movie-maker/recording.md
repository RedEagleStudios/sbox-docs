...
After making your recording, you can then polish it up in the [Motion Editor](/doc/systems/movie-maker/motion-editing) or [Keyframe Editor](/doc/systems/movie-maker/keyframe-editing). Here's some extra recording specific tips:

## Cutting

Your best bet here is to save your recording to a separate .movie, then reference it as a [sequence block](/doc/systems/movie-maker/sequences) in your main project. This lets you take clips from the recording, tweaking the start and end times as needed.
