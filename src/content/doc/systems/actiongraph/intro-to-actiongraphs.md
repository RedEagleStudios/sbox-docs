...
- [Use the built-in Component actions](/doc/systems/actiongraph/component-actions)

- Use the Component Editor to create methods in a custom component

- [Add a Delegate-type property to a custom component in C#](/doc/systems/actiongraph/using-with-c)
...
- [How to use variables](/doc/systems/actiongraph/variables)

- [Creating your own custom nodes](/doc/systems/actiongraph/custom-nodes)