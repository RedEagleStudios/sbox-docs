...
Adding this [Component](/doc/scene/components) to a [GameObject](/doc/scene/gameobject) in the [Scene](/doc/scene/scenes) will ensure the connection is started when the game starts.
...
You could attach an [Auth Token](/doc/systems/services/auth-tokens) to your WebSocket request header like so:
