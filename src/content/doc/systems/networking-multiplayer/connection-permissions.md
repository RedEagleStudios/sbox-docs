...
The host can change some permissions for a specific `Connection`. The ideal place to set these permissions would be in the `OnActive` [network event.](/doc/systems/networking-multiplayer/network-events)
