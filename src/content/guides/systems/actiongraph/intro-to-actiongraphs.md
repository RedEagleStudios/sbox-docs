...
![A simple graph with action nodes (blue), expression nodes (green), and links between them. White links with arrows at either end carry signals that control when nodes run.](https://cdn.sbox.game/doc/ac32563d-287a-4b0c-90d3-b696f71db04e)

## Creating a new ActionGraph

To start using ActionGraph in your project, you can either:

- [Use the built-in Component actions](/guides/systems/actiongraph/component-actions)

- Use the Component Editor to create methods in a custom component

- [Add a Delegate-type property to a custom component in C#](/guides/systems/actiongraph/using-with-c)
...
![Node creation menu.](https://cdn.sbox.game/doc/48d17113-1f7b-4116-94ea-f74bdbd12b94)
...
![Some example expression nodes.](https://cdn.sbox.game/doc/7f595f6f-e4e5-41a8-a93a-ea4aca79d72b)
...
![An example graph using only action nodes that counts to 10.](https://cdn.sbox.game/doc/aaa07059-012d-4a52-a4ce-1268f2013443)
...
![Setting constant values for the inputs in a For Range node.](https://cdn.sbox.game/doc/03d91ed0-4532-41c6-8ab4-46d8aaf1fa1f)

## Next Steps

Now you know the basics, the next things to learn are:

- [How to use variables](/guides/systems/actiongraph/variables)

- [Creating your own custom nodes](/guides/systems/actiongraph/custom-nodes)