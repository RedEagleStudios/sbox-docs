...
You can find information about how to install and use SteamCMD here [https://developer.valvesoftware.com/wiki/SteamCMD](https://developer.valvesoftware.com/wiki/SteamCMD) to install the s&box Dedicated Server.
