---
title: "Writing Snapshot Data"
slug: "systems/networking-multiplayer/custom-snapshot-data"
order: 52
category: "systems"
...
[Components](/guides/scene/components) in the [Scene](/guides/scene/scenes) can write and read their own data during the snapshot sending and receiving process by implementing `Component.INetworkSnapshot`.
...
void INetworkSnapshot.ReadSnapshot( ref ByteStream reader )
	{
        ...
        MyVoxelData = reader.ReadArray( length ).ToArray();
	}
