---
title: "Example"
slug: "systems/networking-multiplayer/rpc-messages"
order: 45
category: "systems"
source: "https://sbox.game/dev/doc/systems/networking-multiplayer/rpc-messages/"
---

[Components](/guides/scene/components) can contain RPCs. An RPC is a function that when called, is called remotely too.

Supported RPC arguments are the exact same as [Sync properties.](/guides/systems/networking-multiplayer/sync-properties)
