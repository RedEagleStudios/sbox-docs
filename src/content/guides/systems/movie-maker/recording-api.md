...
slug: "systems/movie-maker/recording-api"
order: 36
category: "systems"
...
```csharp
class ModelRendererCapturer : ComponentCapturer
{
...
var options = new MovieRecorderOptions()
    ...
    {
        foreach ( var renderer in recorder.Scene.GetAllComponents() )
        {
