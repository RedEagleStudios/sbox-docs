...
You'll also need to be in the [Motion Editor](/guides/systems/movie-maker/motion-editing) to do the modifications described in this tutorial.
...
You should know the basics of [Motion Editing](/guides/systems/movie-maker/motion-editing) before getting started here.
