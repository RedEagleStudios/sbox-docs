...
Editor UI is built entirely out of Widgets. Widgets are different from [Panels](/guides/systems/ui), which are used for in-game UI. Widgets can be various elements or components, such as labels, buttons, text boxes, trees, or images.
