...
Component Editor Tools work a lot like regular Editor Tools, but they're always active when a specific [Component](/guides/scene/components) is selected. These tools generally create UI in the scene view, but they can also override input too.

![The camera preview is created using a Component EditorTool](https://cdn.sbox.game/doc/4cb18c8d-d0fd-4d23-89da-3ccc37ec438e)

An example of a component tool is the camera preview - which is shown when a [GameObject](/guides/scene/gameobject) with a CameraComponent is shown.
